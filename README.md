...
This is a port of the ModAPI mod by Moritz as ModAPI no longer supports the game. The original mod is here https://modapi.survivetheforest.net/mod/72/item-spawner

#### What it does

Lets you spawn all the items you want.
...
* Open Menu Key (Default F3) - Keybind to open spawn menu